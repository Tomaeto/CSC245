	...
	{
		//Public instance of printLtSubtree, calls
		//	private instance
		printLtSubtree(2);
	}
       	...
       	int BinaryHeap<Comparable> :: Height() const
	{
		...
		int h = -1;
		while (int(pow(2, h+1)) - 1 < currentSize)
		{
			h++;
		}
		return h;
...
/*10*/      array[ hole ] = tmp;
	...
	{
		//Public printLeaves function, acts as call to private
		printLeaves(1);
	}
	...
	{
		//Prints all leaf nodes of the heap starting from
		//given index
